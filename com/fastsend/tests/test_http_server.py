# -*- coding: utf-8 -*-
"""
simpleHttpServer request handler tests.
"""
__author__ = 'self'

from nose import tools
from com.fastsend.util.mockClientSocket import MockClientSocket
from com.fastsend.net.httpServer import handle_request
